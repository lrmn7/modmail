          ...
          new EmbedBuilder()
            ...
            .addFields(
              ...
              },
              {
                ...
                value: "Unfortunately, you are not allowed to reshare this code from lrmn6666 Please DM him and ask the permission to share, else you will get a copyright warning from him. Thanks :)"
              }
            )
            .setColor('Blue')
            .setFooter(
              {
                text: "Developed by: LRMN#6666"
              }
            )
        ],
        ephemeral: true
